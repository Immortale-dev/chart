...
proto._updateBounds = function(){
    ...
    this._xAxis.setValues({from:this.xFrames.min, to:this.xFrames.max, count: this._calcXAxisCount()});
    this._yAxis.setValues({from:this.yFrames.min, to:this.yFrames.max, count: this._calcYAxisCount()});
